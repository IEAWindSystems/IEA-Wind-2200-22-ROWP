...
def main():
    if __name__ == '__main__':
        ...
        # array-like input
        res = qlsm.predict(RP=[10, 15, 22], D=[198, 240, 284], HTrans=[10, 15, 15], HHub_Ratio=[119/198, 150/240, 170/284], WaterDepth=3 * [32], WaveHeight=3 * [3.5], WavePeriod=3 * [6], WindSpeed=3 * [9])
        print(res)
